  ...
  randomDrawItem = () => {
    ...
    if (removeDrawnItem) {
      const copyCurrentItems = [...this.state.currentItems];
        DrawHide.splice(randomIndex, 1);
      this.setState({
          currentItems: DrawHide,
      });
    }
  };
